...
builder = LevelBuilder(500, 500)
scene = builder.create("easy")
# print("avail size", [builder.padding, 500-builder.padding], scene.planets[0].pos())

# # screen_x, screen_y = 900,700
# # sc = Spacecraft('Test', mass = 100, thrust_force = 3000, gas_level = 600)
# # orbit = Orbit(a=screen_x*500/1920, b=screen_y*500/1080, center_x=screen_x, center_y=screen_y/2, CW=True, angular_step = 2*math.pi/(200.0), progress = math.pi/2)
