...
while not level_won and not level_fail:
    ...
    for planet in game.current_scene.planets:
        pygame.draw.ellipse(
            screen, (100, 100, 100), pygame.Rect(planet.x - 25, planet.y - 25, 50, 50)
        )
        # Orbit
        pygame.draw.ellipse(
            screen,
            (255, 255, 255),
            pygame.Rect(
                planet.orbit.center_x - planet.orbit.a,
                planet.orbit.center_y - planet.orbit.b,
                planet.orbit.a * 2,
                planet.orbit.b * 2,
            ),
            1,
    ...
    pygame.draw.polygon(
        screen, (255, 100, 100), game.current_scene.sc.poly.exterior.coords
    )
