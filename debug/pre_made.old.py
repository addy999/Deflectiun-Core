...
level2 = GameScene(
    ...
    sc=sc,
    planets=[planet],
    win_region=([screen_x, 0], [screen_x, screen_y / 10]),
    win_velocity=90.0,
...
orbit = Orbit(
    a=screen_x * 800 / 1920,
    b=screen_y * 300 / 1080,
    center_x=screen_x * 0.75,
    center_y=screen_x * 0.25,
    CW=True,
    angular_step=2 * math.pi / (200.0),
    progress=math.pi / 4,
)
...
orbit = Orbit(
    ...
    b=screen_y * 800 / 1080,
    center_x=0.0,
    center_y=3 * screen_y / 4,
    CW=False,
    angular_step=math.pi / (200.0),
    progress=0.0,
)
...
level4 = GameScene(
    ...
    win_region=([screen_x, 0], [screen_x, screen_y / 7]),
    win_velocity=150,
...
level6 = GameScene(
    ...
    win_region=([screen_x * 0.75, 0], [screen_x, 0.0]),
    win_velocity=100,
    background=getModpath() + r"/images/stars_6.jpg",
    sc_start_pos=[0.0, screen_y],
)
##################################

game = Game(
    scenes=[level1, level2, level6, level3, level4, level5], fullscreen=True, fps=120
)
